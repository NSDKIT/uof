...
t_331 = datetime(Year,3,31);dn_331 = day(t_331,'dayofyear'); %3月31日の日付番号を取得
if Month==3 && Day==31
    dn=length(date_strings);
elseif dn > 90
    dn = dn - dn_331; %解析対象日の日付番号を取得
else
    t_1231 = datetime(Year,12,31);dn_1231 = day(t_1231,'dayofyear'); %12月31日の日付番号を取得
    dn = dn_1231-dn_331+dn; %解析対象日の日付番号を取得
end
