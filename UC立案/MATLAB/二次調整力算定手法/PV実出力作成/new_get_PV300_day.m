...
%% システム出力係数
PR=[0.678254793,0.767485035,0.722604658,...
    0.769037659,0.786566701,0.754861278,...
    0.738442827,0.770087352,0.815766957,...
    0.759882485,0.817871495,0.90996671];
%% 年月日を選択
Month = month;
Day = day;
if Month > 3
...
if year == 2018
    if month == 5
        if day == 18 || day == 19 || day == 20 || day == 21 || day == 22 || day == 23 || day == 24 || day == 25
            A_R = 1:16;
        else
            A_R = 1:17;
        end
